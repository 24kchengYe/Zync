...
function getAttentionState(runtimeStatus: RuntimeStatus, isStale: boolean): AttentionState {
...
function getAgentChipClass(runtimeStatus: RuntimeStatus): string {
...
function getAgentDotClass(runtimeStatus: RuntimeStatus): string {
  switch (runtimeStatus) {
    case 'running':
...
function getAttentionChipClass(attentionState: AttentionState): string {
...
function getSyncSummary(mainBranchStatus?: MainBranchStatus): {
  syncValue: string;
  syncCaptionKey:
