      ...
      <div className="space-y-0.5 text-[10px]">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-text-secondary">
            {createdDate}
            {lastActiveAgo && <span className="text-text-tertiary"> Â· active {lastActiveAgo}</span>}
          </span>
        </div>
      </div>
      ...
      <>
        ...
        >
          ...
          <div className="flex items-center justify-center px-1 py-2 border-b border-border-primary">
            <img src={paneLogo} alt="Zync" className="h-6 w-6" />
          </div>
      ...
      >
        ...
        <div className="px-3 py-2 border-b border-border-primary flex items-center justify-between overflow-hidden">
          <div className="flex items-center space-x-2 min-w-0">
            <img src={paneLogo} alt="Zync" className="h-6 w-6 flex-shrink-0" />
            <h1 className="text-xl font-bold truncate">Zync</h1>
          </div>
      ...
      >
        ...
        <ModalBody>
            ...
            <div className="space-y-4">
              ...
              <div className="pb-3 border-b border-border-primary">
                <h4 className="text-sm font-medium text-text-primary mb-2">Workspace Status</h4>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-tertiary text-sm">Workspace has new unviewed results</p>
                    </div>
                  </div>
