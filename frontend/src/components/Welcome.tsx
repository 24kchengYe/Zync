    ...
    <Modal isOpen={isOpen} onClose={onClose} size="lg">
      ...
      <div className="p-6 border-b border-border-primary">
        <div className="flex items-center">
          <img src={paneLogo} alt="Zync" className="h-10 w-10 mr-3" />
          <div>
            <h1 className="text-xl font-semibold text-text-primary">Welcome to Zync</h1>
            <p className="text-sm text-text-tertiary">Multi-Agent Workspace Manager</p>
          </div>
        </div>
      </div>
            ...
            <section>
              ...
              <div className="bg-status-warning/10 border border-status-warning/30 rounded-lg p-4 mb-4">
                ...
                <ul className="space-y-2 text-status-warning/80">
                  ...
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    <span>Zync runs Claude Code with <code className="bg-status-warning/20 px-1 rounded text-sm">--dangerously-ignore-permissions</code></span>
                  </li>
                </ul>
              </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <ul className="text-text-secondary space-y-1 text-sm">
                      <li>• Point to a <strong>new directory</strong> - Zync will create it and initialize git</li>
