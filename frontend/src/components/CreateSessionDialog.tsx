...
import { GitBranch, ChevronRight, ChevronDown, X, Search, Check, GitFork, ShieldOff, Shield } from 'lucide-react';
...
export function CreateSessionDialog({
  ...
  return (
    ...
    >
      <ModalHeader>
        New Workspace{projectName && ` in ${projectName}`}
      </ModalHeader>
          ...
          <form id="create-session-form" onSubmit={handleSubmit}>
            ...
            {isLoadingBranches && branches.length === 0 ? (
              ...
              <div className="p-6 border-b border-border-primary">
                ...
                <p className="text-xs text-text-tertiary mb-1">(version to start from)</p>
            ...
            {showAdvanced && (
              <div className="px-6 pb-6 space-y-4 border-t border-border-primary pt-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <ToggleField
                    label="Use worktree"
                    description="Run in an isolated copy — won't affect your original files."
                    checked={useWorktree}
                    onChange={(checked) => {
                ...
                {/* Permission Mode */}
                <div>
                  <label className="text-sm font-medium text-text-primary mb-2 block">Security Mode</label>
                  <div className="flex gap-2">
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="text-sm font-medium">Fast & Flexible</div>
                        <div className="text-xs opacity-70">Auto-approve all</div>
                      </div>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <div className="text-left">
                        <div className="text-sm font-medium">Secure & Controlled</div>
                        <div className="text-xs opacity-70">Manual approval</div>
                      </div>
                    </button>
                  </div>
                </div>
