# Zync Release Instructions

This document outlines the process for releasing new versions of Zync for macOS with automatic updates.
...
1. Go to https://github.com/24kchengYe/Zync/releases
...
1. Install an older version of Zync
2. Zync will automatically check for updates on startup
...
- Zync checks for updates on startup and every 24 hours