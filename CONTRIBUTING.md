...
Thank you for your interest in contributing to Zync! We welcome contributions from the community and are excited to work with you.

Zync is an open source project created by [Yecheng Zhang](https://github.com/24kchengYe).

## Right to Contribute this Code
- You represent and warrant that You are legally entitled to contribute the code you contribute to Zync
...
### Current Status
Zync doesn't have automated tests yet - we welcome contributions to add them! If you'd like to help set up a testing framework, please open an issue to discuss the approach.
...
Thank you for contributing to Zync!
