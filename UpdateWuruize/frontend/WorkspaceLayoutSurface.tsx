...
import { getWorkspaceLayoutVisibleSlots } from './WorkspaceLayoutDemoState';
...
function getPanelDisplayTitle(panel: ToolPanel, t: ReturnType<typeof useI18n>['t']) {
...
function getLayoutSurfaceClasses(layoutMode: WorkspaceLayoutMode) {
...
function getSlotDefinitions(layoutMode: WorkspaceLayoutMode): SlotDefinition[] {
  if (layoutMode === 'columns') {
    return [
