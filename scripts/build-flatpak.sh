...
echo "Building Flatpak package for Zync..."
...
sed -i "s|path: dist-electron/Pane-\*.AppImage|path: $APPIMAGE|" com.zync.app.yml

# Build the Flatpak
echo "Building Flatpak..."
flatpak-builder --force-clean --repo=repo build-dir com.zync.app.yml

# Create a single-file bundle
echo "Creating Flatpak bundle..."
flatpak build-bundle repo pane.flatpak com.zync.app

# Restore the manifest
git checkout com.zync.app.yml
